...
![](images/typeface_setup-usaid-style_font.png){fig-alt="Snapshot from USAID's Graphic Standards and Partner Co-Branding Guide showing the web typeface as Source Sans Pro Light"}
...
![](images/typeface_setup-software-center_font.png){fig-alt="Software Center window with Source Sans Pro highlighted"}
...
![](images/typeface_setup-typeface_installed.png){fig-alt="Output in R Console showing Source Sans Pro family installed"}
