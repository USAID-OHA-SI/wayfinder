...
# Check what version of R & Rstudio you are using. 
# Note: Try to use the most recent versions.
R.version.string
```
...
# This will also return the version of R-studio
