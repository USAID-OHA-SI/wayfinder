...
![Software Center window with R and RStudio highlighted](/assets/img/software-center_r.png)
...
![RStudio Global Options menu with the items above changed](/assets/img/global-options.png)
...
![RStudio Global Options highlighting where to access Snippets](/assets/img/snippets_global-options.png)
...
![RStudio Snippet window showing user created setup](/assets/img/snippet-window.png)
...
![RStudio Console window showing autofill of Snippet name](/assets/img/snippet_insert.png)
